...
import 'package:elzsi/Screens/Executive/Auth/executive_update_profile_screen.dart';
...
class ExecutiveVerificationScreen extends StatefulWidget {
  const ExecutiveVerificationScreen({super.key, required this.data});

  final Map data;

  @override
  State<ExecutiveVerificationScreen> createState() =>
      _ExecutiveVerificationScreenState();
}

class _ExecutiveVerificationScreenState
    extends State<ExecutiveVerificationScreen> {
  //DEVICE INFO
  String thisDeviceId = '';
  ...
  void _resendOTP() async {
    ...
    var data = {"user_type": "EXECUTIVE", "mobile": widget.data['data']};
