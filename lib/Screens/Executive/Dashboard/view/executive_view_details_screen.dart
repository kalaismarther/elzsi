...
class ExecutiveViewDetailsScreen extends StatefulWidget {
  const ExecutiveViewDetailsScreen({super.key, required this.data});

  final Map data;

  @override
  State<ExecutiveViewDetailsScreen> createState() =>
      _ExecutiveViewDetailsScreenState();
}

class _ExecutiveViewDetailsScreenState
    extends State<ExecutiveViewDetailsScreen> {
  @override
  void initState() {
  ...
  //LIST FOR STORING LINKED PROJECTS OF SELLER
  List linkedSellerProjects = [];

  //FUNCTION FOR GETTING LINKED SELLER PROJECTS LIST
