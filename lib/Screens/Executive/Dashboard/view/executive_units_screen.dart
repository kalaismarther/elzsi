...
class ExecutiveUnitsScreen extends StatefulWidget {
  const ExecutiveUnitsScreen({super.key, required this.agentUnitsList});

  final List agentUnitsList;

  @override
  State<ExecutiveUnitsScreen> createState() => _ExecutiveUnitsScreenState();
}

class _ExecutiveUnitsScreenState extends State<ExecutiveUnitsScreen> {
  @override
