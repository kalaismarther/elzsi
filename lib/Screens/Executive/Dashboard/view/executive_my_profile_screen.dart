...
// class _ExecutiveMyProfileScreenState extends State<ExecutiveMyProfileScreen> {
//   @override
//   void initState() {
...
//               "handled_projects": existingControllers[info][4].text,
//               "position_held": existingControllers[info][5].text,
//             });
//           }
//         }
//         //ADD FILES
...
//     print('${userInfo.userId} ${userInfo.token}');
...
//             : 'offline';
//       });
//       print(_uploadedAadhaarLink);
//       for (int existingDetail = 0;
//           existingDetail < result['data']['existing_sellers'].length;
//           existingDetail++) {
//         existingControllers.add([
//           TextEditingController(),
//           TextEditingController(),
...
//           TextEditingController(),
//         ]);
//         existingControllers[existingDetail][0].text =
//             profileInfo!['existing_sellers'][existingDetail]['business_name'];
//         existingControllers[existingDetail][1].text =
//             profileInfo!['existing_sellers'][existingDetail]['person_name'];
//         existingControllers[existingDetail][2].text =
//             profileInfo!['existing_sellers'][existingDetail]['contact_number'];
//         existingControllers[existingDetail][3].text =
//             profileInfo!['existing_sellers'][existingDetail]['since_yrmonth']
//                 .replaceAll('-', '/');
//         existingControllers[existingDetail][4].text =
//             profileInfo!['existing_sellers'][existingDetail]
//                 ['handled_projects'];
//         existingControllers[existingDetail][5].text =
//             profileInfo!['existing_sellers'][existingDetail]['position_held'];
//         centerLoading = false;
//       }
//     } else {
...
//                                   SizedBox(
//                                     width: screenWidth * 0.2,
//                                     child: _uploadedAadhaarLink == null ||
//                                             _uploadedAadhaarLink!.isEmpty
//                                         ? InkWell(
