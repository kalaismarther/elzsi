...
class _ExecutivePropertiesScreenState extends State<ExecutivePropertiesScreen> {
  @override
  void initState() {
  ...
  //LIST FOR STORING LINKED PROPERTIES
  List propertiesList = [];

  //FUNCTION FOR GETTING LINKED PROPERTIES LIST
  Future<void> _getPropertyList() async {
    ...
    final result = await Api().getLinkedProjects(data, userInfo.token, context);
